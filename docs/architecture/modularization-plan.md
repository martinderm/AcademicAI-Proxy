...
| [`academicai/cost_monitoring.py`](../../academicai/cost_monitoring.py) | AcademicAI cost cache & header injection | `get_cost_cache_with_lazy_refresh()`, `build_cost_headers()`, `write_cost_cache()`, `get_cost_status_payload()` |
